...
namespace Project
{
    public partial class MainForm : Form
    {
        ...
        private readonly Color NormalButtonColor = Color.FromArgb(225, 240, 255); 
        private readonly Color ActiveButtonColor = Color.FromArgb(0, 120, 215);   
        private readonly Color NormalForeColor = SystemColors.ControlText;       
